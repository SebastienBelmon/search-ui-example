...
const combineAggregationsFromResponses = responses => {
...
const removeFilterByName = (state, facetName) => {
  return {
    ...state,
...
const removeAllFacetsExcept = (body, facetName) => {
  return {
    ...body,
    aggs: {
...
const getDisjunctiveFacetCounts = async (state, disunctiveFacetNames) => {
