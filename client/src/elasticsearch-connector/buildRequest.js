// fortement inspiré de https://github.com/elastic/search-ui/tree/master/examples/elasticsearch

import buildRequestFilter from './buildRequestFilter';

const buildFrom = (current, resultsPerPage) => {
  if (!current || !resultsPerPage) return;
  return (current - 1) * resultsPerPage;
};

const buildSort = (sortDirection, sortField) => {
